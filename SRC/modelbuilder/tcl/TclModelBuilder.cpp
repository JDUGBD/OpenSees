...
int TclCommand_mesh(ClientData clientData, Tcl_Interp *interp, int argc,
					TCL_Char **argv);
int TclCommand_remesh(ClientData clientData, Tcl_Interp *interp, int argc,
					  TCL_Char **argv);
#if defined(OPSDEF_Element_PFEM)
int TclCommand_backgroundMesh(ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv);
#endif // _OPS_Element_PFEM

int TclCommand_addUniaxialMaterial(ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv);

int TclCommand_addBeamIntegration(ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv);

int TclCommand_addLimitCurve(ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv);
...
int TclCommand_addYieldSurface_BC(ClientData clientData, Tcl_Interp *interp,
								  int argc, TCL_Char **argv);

int TclCommand_addYS_EvolutionModel(ClientData clientData, Tcl_Interp *interp,
									int argc, TCL_Char **argv);

int TclCommand_addYS_PlasticMaterial(ClientData clientData, Tcl_Interp *interp,
									 int argc, TCL_Char **argv);
...
int TclCommand_addHomogeneousBC(ClientData clientData, Tcl_Interp *interp, int argc,
								TCL_Char **argv);
int TclCommand_addHomogeneousBC_X(ClientData clientData, Tcl_Interp *interp, int argc,
								  TCL_Char **argv);
int TclCommand_addHomogeneousBC_Y(ClientData clientData, Tcl_Interp *interp, int argc,
								  TCL_Char **argv);
int TclCommand_addHomogeneousBC_Z(ClientData clientData, Tcl_Interp *interp, int argc,
								  TCL_Char **argv);
...
int TclCommand_doPySimple1Gen(ClientData clientData, Tcl_Interp *interp, int argc,
							  TCL_Char **argv);

int TclCommand_doTzSimple1Gen(ClientData clientData, Tcl_Interp *interp, int argc,
							  TCL_Char **argv);
// End added by SJB

// Added by Prishati Raychowdhury (UCSD)
int TclModelBuilder_doShallowFoundationGen(ClientData clientData, Tcl_Interp *interp, int argc,
										   TCL_Char **argv);
// End PRC

int TclCommand_doBlock2D(ClientData clientData, Tcl_Interp *interp, int argc,
						 TCL_Char **argv);

int TclCommand_doBlock3D(ClientData clientData, Tcl_Interp *interp, int argc,
						 TCL_Char **argv);

int TclCommand_addRemoPatch(ClientData clientData,
							Tcl_Interp *interp,
							int argc,
							TCL_Char **argv);

int TclCommand_addRemoLayer(ClientData clientData,
							Tcl_Interp *interp,
							int argc,
							TCL_Char **argv);

int TclCommand_addRemoFiber(ClientData clientData,
							Tcl_Interp *interp,
							int argc,
							TCL_Char **argv);

// Leo
int TclModelBuilder_addRemoHFiber(ClientData clientData,
								  Tcl_Interp *interp,
								  int argc,
								  TCL_Char **argv);

int TclCommand_addRemoGeomTransf(ClientData clientData,
								 Tcl_Interp *interp,
								 int argc,
								 TCL_Char **argv);

int TclCommand_addRemoDamping(ClientData clientData,
							  Tcl_Interp *interp,
							  int argc,
							  TCL_Char **argv);
...
int TclCommand_addStiffnessDegradation(ClientData clientData,
									   Tcl_Interp *interp,
									   int argc, TCL_Char **argv);

int TclCommand_addUnloadingRule(ClientData clientData,
								Tcl_Interp *interp,
								int argc, TCL_Char **argv);

int TclCommand_addStrengthDegradation(ClientData clientData,
									  Tcl_Interp *interp,
									  int argc, TCL_Char **argv);

int TclCommand_addHystereticBackbone(ClientData clientData,
									 Tcl_Interp *interp,
									 int argc, TCL_Char **argv);

int TclCommand_addGroundMotion(ClientData clientData,
							   Tcl_Interp *interp,
							   int argc,
							   TCL_Char **argv);

/// added by ZHY
int TclCommand_UpdateMaterialStage(ClientData clientData,
								   Tcl_Interp *interp,
								   int argc,
								   TCL_Char **argv);
int TclCommand_UpdateMaterials(ClientData clientData,
							   Tcl_Interp *interp,
							   int argc,
							   TCL_Char **argv);
...
////////////////gnp adding rayleigh //////////////////////////
int TclCommand_addElementRayleigh(ClientData clientData,
								  Tcl_Interp *interp,
								  int argc,
								  TCL_Char **argv);
///////////////////////////////////////////////////////////////

int TclCommand_IGA(ClientData clientData, Tcl_Interp *interp, int argc, TCL_Char **argv);
...
int TclCommand_GenerateInterfacePoints(ClientData clientData, Tcl_Interp *interp, int argc,
									   TCL_Char **argv);
// End Added by Alborz
...
int TclModelBuilder::buildFE_Model(void)
{
	// does nothing
	return 0;
}

int TclModelBuilder::getNDM(void) const
{
	return ndm;
}

int TclModelBuilder::getNDF(void) const
{
	return ndf;
}
...
extern int TclModelBuilderCyclicModelCommand(ClientData clienData, Tcl_Interp *interp, int argc,
											 TCL_Char **argv, TclModelBuilder *theTclBuilder);
int TclCommand_addCyclicModel(ClientData clientData, Tcl_Interp *interp,
							  int argc, TCL_Char **argv)
...
int TclCommand_addDamageModel(ClientData clientData, Tcl_Interp *interp,
							  int argc, TCL_Char **argv)
...
int TclCommand_addRemoPatch(ClientData clientData, Tcl_Interp *interp, int argc,
							TCL_Char **argv)
{
...
int TclCommand_addRemoFiber(ClientData clientData, Tcl_Interp *interp, int argc,
							TCL_Char **argv)
{
...
int TclModelBuilder_addRemoHFiber(ClientData clientData, Tcl_Interp *interp, int argc,
								  TCL_Char **argv)
{
	return TclCommand_addHFiber(clientData, interp, argc, argv, theTclBuilder);
}

int TclCommand_addRemoLayer(ClientData clientData, Tcl_Interp *interp, int argc,
							TCL_Char **argv)
{
...
int TclCommand_addRemoGeomTransf(ClientData clientData, Tcl_Interp *interp, int argc,
								 TCL_Char **argv)
{
...
int TclCommand_addRemoDamping(ClientData clientData, Tcl_Interp *interp, int argc,
							  TCL_Char **argv)
{
